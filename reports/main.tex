...
%\usepackage{times} % Chọn font Time New Romans (not available, use default)
...
\def \TITLE{ShieldX: An Intelligent Endpoint Security Agent for Malware Detection over DNS-over-HTTPS using Machine Learning}
...
\graphicspath{{figures/}{../figures/}{Figure/}} % Thư mục chứa các hình ảnh
